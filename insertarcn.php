...
<html lang="en">
    <head>
        <title>Cancelación - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Revise los datos de la reserva a cancelar</b></h1>
                                <BR></BR>
                                <HR></HR>
                                <form action="updatecn.php" method="POST">
                                <div class="container mt-5 custom-container"  style="margin:auto; text-align: center; width: 850px;">
                                    ...
                                    <p>Fecha</p>
                                    <input type="date" class="form-control mb-3" name="fecha" placeholder="Fecha" value="<?php  echo $row['fecha']?>" readonly>
                                    <p>Día</p>
                                    ...
                                    <p>Salida</p>
                                    <input type="date" class="form-control mb-3" name="salida" placeholder="Salida" value="<?php  echo $row['salida']?>" readonly>
                                    <p>Cliente</p>
                                    ...
                                    <input type="int" class="form-control mb-3" name="sextras" placeholder="Servicios Especiales" value="<?php  echo $row['sextras']?>" readonly>
                                    <p>Consumos Extras</p>
                                    ...
                                    <p>Costo por cancelación</p>
                                    <select class="form-control mb-3" id="cc" name="cc" placeholder="cc" required>
                                    ...
                                    <p>Comentarios</p>
                                    <input type="int" class="form-control mb-3" name="comentarios" class="form-control mb-3" placeholder="Comentarios" required>
                                    </div>
                                    </div>
                                    <br>
                                    <br>
                                    <input type="submit" class="btn btn-primary btn-block" value="Cancelar Reservación">
                                    <br>
                                </form>
                        </div>
                    </div>
