...
<html lang="en">
    <head>
        <title>Añadir descuento (Check In) - Casa Flora Handmade Hotel</title>
...
<link rel="stylesheet" href="css/responsive.css?v=2">
        ...
        function restar() {
            ...
            document.getElementById("restante").textContent = "El nuevo total es: " + total;
        }
        </script>
        <style>
            .logo-img {
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Agregar descuento</b></h1>
                                ...
                                <div class="row"> 
                                    ...
                                    <fieldset>
                                        <div>
                                            ...
                                            <br><br>
                                            <h3 class="h3">Introduzca la cantidad que desea descontar.</h3>
                                            <br><br>
                                        </div>
                                        <div style="text-align: center;">
                                            <span class="h3">Total anterior</span>
                                            <input type="text" id="campo1" value="<?php echo $row['gtotal']; ?>" readonly/>
                                            <span class="h3">Descuento</span>
                                        ...
                                        <br>
                                        <form action="insertadesc.php" method="POST" name="eform" onsubmit="return redirect()" style="max-width:500px;margin:auto">
                                            ...
                                            <!--Total-->
                                            <input type="int" class="form-control mb-3" id="resultado" name="total" placeholder="Introduzca el nuevo total sin signos" pattern="^[^-]*$" oninput="this.value = this.value.replace(/[^\d.-]/g, '')" required>
