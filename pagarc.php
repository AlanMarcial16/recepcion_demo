                                    ...
                                    <fieldset>
                                        ...
                                        <form action="insertapago.php" method="POST" style="max-width:500px;margin:auto">
                                            ...
                                            <select class="form-control mb-3" id="pago" name="pago" placeholder="Método de Pago" onchange="cambiarch()" required>
                                                ...
                                                <option value="pagoe.php?id=<?php echo $row['cod_reserva'] ?>">EFECTIVO</option>
                                                <option value="pagot.php?id=<?php echo $row['cod_reserva'] ?>">TARJETA DE CRÉDITO/DÉBITO</option>
                                                <option value="pagosp.php?id=<?php echo $row['cod_reserva'] ?>">TRANSFERENCIA INTERBANCARIA (SPEI)</option>
                                                <option value="pagoopenpay2.php?id=<?php echo $row['cod_reserva'] ?>">OPENPAY</option>
                                            </select>
