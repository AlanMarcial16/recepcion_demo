...
$sql = "UPDATE reservaciones SET fecha='$fecha', dia='$dia', llegada='$llegada', salida='$salida', cliente='$cliente', 
        ...
        noches='$noches', garantia='$garantia', cextras='0', textras='0', pago='$pago', total='0', gtotal='0' WHERE cod_reserva='$cod_reserva'";
$query = mysqli_query($con, $sql);

/*if (isset($_POST['garantia']) && $_POST['garantia'] == "D.S. $400") {
    // Obtener el valor de $habitacion aquí
    // Ejecutar el query
    $sql = "INSERT INTO cajaop (cod_operacion, tipodeoperacion, descripcion, tipocomprobante, importeentrada, importesalida, fecha_hora_registro) 
...
if ($query) {
    Header("Location: asignar_hab.php?id=$cod_reserva");
} else {
