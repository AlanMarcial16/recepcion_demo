...
<html lang="en">
    <head>
        <title>Check Out - Añadir descuento</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Check Out - Aplicar descuento</b></h1>
                                <div class="container mt-5 custom-container">
                                <div class="row"> 
                                    <div>
                                    <div class="card">
                                    <h4 style="text-align: right;">Reserva: #<?php  echo $row['cod_reserva']?> </h4>
                                    <a style="text-align: right;" href="cobrarc.php?id=<?php echo $row['cod_reserva'] ?>">
                                    ...
                                    <fieldset>
                                        ...
                                        <br><br>
                                        <form action="insertadesc2.php" method="POST" name="eform" onsubmit="return redirect()" style="max-width:500px;margin:auto">
