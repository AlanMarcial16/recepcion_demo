...
<html lang="en">
    <head>
        <title>Facturas - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <a href="facturas.php">
                                    <button class="btn info"><i class="fa1 fa fa-file-o"></i></button>
                                </a>
                                </script>
                                <a href="selb.php">
                                ...
                                <br>
                                <h1 style="text-align: center;"><b>Facturación - Facturas Emitidas</b></h1>
                                <br>
                                <hr>
                                <br>
...
<script>
    ...
    if ($filter === 'hoy') {
        ...
        if ($fecha_inicio && $fecha_fin) {
            $sql .= " WHERE DATE(salida) BETWEEN '$fecha_inicio' AND '$fecha_fin'";
        }
    }

    // Ordenar las facturas por fecha de salida descendente
    $sql .= " ORDER BY salida DESC";
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2"><?php  echo $row['lugar']?></th>
                                            <th colspan="2"><?php  echo $row['pago']?></th>
                                            <th colspan="2">$<?php  echo $row['total']?></th>
                                            <th colspan="2">
                                            <a href="formcheck.php?id=<?php echo $row['cod_reserva'] ?>" class="btn btn-success">
