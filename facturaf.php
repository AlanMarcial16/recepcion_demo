            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <a href="reservended.php?id=<?php echo $row['cod_reserva'] ?>">
                                ...
                                <form action="insertfactura.php" method="POST" style="max-width:500px;margin:auto">
                                    ...
                                    <input type="int" class="form-control mb-3" name="lugar" class="form-control mb-3" placeholder="Introduzca el lugar de expedición" required>
                                    <p>Descripción del servicio brindado</p>
                                    <input type="int" class="form-control mb-3" name="descrip" class="form-control mb-3" placeholder="Introduzca la descripción" required>
                                    <p>Correo electrónico</p>
                                    <input type="int" class="form-control mb-3" name="email" placeholder="Correo Electrónico" required>
                                    <p>Teléfono</p>
                                    <input type="int" class="form-control mb-3" name="telefono" placeholder="Teléfono" required>
                                    <p>Método de pago</p>
                                    <input type="int" class="form-control mb-3" name="pago" placeholder="Método de pago" required>
                                    <p>Total</p>
