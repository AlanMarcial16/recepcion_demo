            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Buscador</b></h1>


                                <div class="button-container">
                                    <a href="selb2.php">
                                        <button class="btn2">Buscar reservas finalizadas</button>
                                    </a>
                                    <a href="selb.php">
                                        <button class="btn2">Buscar reservas vigentes</button>
                                    </a>
                                    <a href="selb3.php">
                                        <button class="btn2">Buscar tickets</button>
                                    </a>
                                </div>
