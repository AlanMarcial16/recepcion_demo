            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Revise/Edite los datos de la Reserva proveniente de Cotización</b></h1>
                                <BR></BR>
                                <HR></HR>
                                ...
                                <div class="container mt-5 custom-container"  style="margin:auto; text-align: center; width: 850px;">
                                    ...
                                    <div class="col-md-6">
                                    <p><b>Fecha</b></p>
                                    <input type="date" class="form-control mb-3" onblur="dif(), filterOptionsByMonth()" id="fecha" name="fecha" placeholder="Fecha" onChange="alertDiaDeSemana(), dif(), updateSelect3Options()" value="<?php echo $fecha; ?>" required>
                                    ...
                                    <p><b>Salida</b></p>
                                    <input type="date" class="form-control mb-3" onchange="dif()" onblur="dif()" id="salida" name="salida" placeholder="Salida" value="<?php echo $salida; ?>" required>
                                    <p><b>Número de noches</b></p>
                                    <input class="form-control mb-3" id="noches" name="noches" placeholder="Noches" onkeypress="return event.charCode>=48 && event.charCode<=57" value="<?php echo $noches; ?>" readonly required>
                                    <p><b>Nombre del Cliente</b></p>
                                    <input type="int" class="form-control mb-3" id="cliente" name="cliente" placeholder="Ingrese el nombre del cliente" onblur="upperCase()" onkeypress="return SoloLetras(event)" value="<?php echo $cliente; ?>" required>
                                    <p><b>Correo electrónico</b></p>
                                    <input type="int" class="form-control mb-3" name="email" placeholder="Ingrese el correo electrónico" value="<?php echo $email; ?>" required>
                                    <p><b>Número de teléfono</b></p>
                                    <input type="int" class="form-control mb-3" name="telefono" placeholder="Ingrese el número de teléfono" onkeypress="return event.charCode>=48 && event.charCode<=57" value="<?php echo $telefono; ?>" required>
                                    </div>
                                    <div class="col-md-6">
                                    <hr>
