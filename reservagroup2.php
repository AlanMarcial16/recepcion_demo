...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    ...
    $sql = "SELECT * FROM reservaciones ORDER BY cod_reserva DESC LIMIT 1";
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <br>
                                <h1 style="text-align: center;"><b>Ingrese los datos de la Reserva en grupo</b></h1>
                                <BR></BR>
                                <HR></HR>
                                ...
                                <div class="row">
                                    ...
                                    <p>Día</p>
                                    <input type="int" class="form-control mb-3" name="dia" placeholder="Día" value="<?php  echo $row['dia']?>" required>
                                    <p>Llegada</p>
                                    <input type="time" class="form-control mb-3" name="llegada" placeholder="Llegada" value="<?php  echo $row['llegada']?>" required>
                                    <p>Salida</p>
                                    ...
                                    <input type="int" class="form-control mb-3" id="cliente" name="cliente" placeholder="Ingrese el nombre del cliente" onblur="upperCase()" onkeypress="return SoloLetras(event)" value="<?php  echo $row['cliente']?>" required>
                                    <p>Correo electrónico</p>
                                    <input type="int" class="form-control mb-3" name="email" placeholder="Ingrese el correo electrónico" value="<?php  echo $row['email']?>" required>
                                    </div>
                                    <div class="col-md-6">
                                    <p>Número de teléfono</p>
                                    <input type="int" class="form-control mb-3" name="telefono" placeholder="Ingrese el número de teléfono" onkeypress="return event.charCode>=48 && event.charCode<=57" value="<?php  echo $row['telefono']?>" required>
