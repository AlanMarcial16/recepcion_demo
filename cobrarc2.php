            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Consumos - <?php  echo $row['cliente']?></b></h1>
                                <div class="container mt-5 custom-container">
                                ...
                                <fieldset> 
                                    ...
                                    <div class="container">
                                        ...
                                        <br><br>
                                        <h1 class="h1" style="<?php echo ($row['textras'] < 0) ? 'color: red;' : '' ?>">
                                            <b>Total: $<?php  echo $row['textras']?> M.N.</b>
                                        </h1>
                                        <br><br>
                                        ...
                                        <a href="pagarc2.php?id=<?php echo $row['cod_reserva'] ?>">
