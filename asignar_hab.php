            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <a href="pagar.php?id=<?php echo $row['cod_reserva'] ?>">
                                ...
                                <div class="row"> 
                                <div>
                                    <h1 class="h1">Seleccione una de las habitaciones disponibles para la clasificación: <b><?php  echo $row['habitacion']?></b> </h1>
                                    <br><br>
                                    <form action="updateh.php" method="POST" onsubmit="return validarFormulario()" style="max-width:500px;margin:auto">
                                            ...
                                            <select class="form-control mb-3" id="habitacion" name="habitacion" placeholder="Habitación" required>
                                                ...
                                                <?php
                                                $tipoHabitacion = $row['habitacion'];
                                                $query2 = mysqli_query($con, "SELECT nombre FROM habitaciones WHERE tipo = '$tipoHabitacion' AND estado = 'disponible'");
                                                ...
                                                <?php if (!$optionsAdded): // Verificar si no se agregaron opciones ?>
                                            ...
                                            <script>
                                                    function validarFormulario() {
                                                        // Obtener el valor seleccionado del selector de habitación
                                                        var habitacionSeleccionada = document.getElementById('habitacion').value;

                                                        // Verificar si no se ha seleccionado una habitación
                                                        if (habitacionSeleccionada === "") {
                                                            // Mostrar una alerta utilizando SweetAlert
                                                            Swal.fire("Elige una opción para continuar", "", "warning");

                                                            // Devolver false para evitar que el formulario se envíe
                                                            return false;
                                                        }

                                                        // Si se ha seleccionado una habitación, permitir el envío del formulario
                                                        return true;
                                                    }
                                                </script>
