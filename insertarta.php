...
<html lang="en">
    <head>
        <title>Editar tarifa - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <form action="updatepos5.php" method="POST" style="max-width:500px;margin:auto">
                                    <h1>Edite el monto de la tarifa</h1>
                                    <br>
                                    <hr>
                                    ...
                                    <input type="int" class="form-control mb-3" name="tarifa" placeholder="Tarifa" value="<?php  echo $row['tarifa']?>" required>
                                    <input type="hidden" class="form-control mb-3" name="huespedes" placeholder="Tarifa" value="<?php  echo $row['huespedes']?>" readonly>
                                    <input type="hidden" class="form-control mb-3" name="anticipo" placeholder="Anticipo" onkeypress="return event.charCode>=48 && event.charCode<=57" value="<?php  echo $row['anticipo']?>" required>
