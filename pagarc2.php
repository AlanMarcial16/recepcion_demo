...
<html lang="en">
    <head>
        <title>Pagar consumos - Casa Flora Handmade Hotel</title>
                                    ...
                                    <fieldset>
                                        ...
                                        <form action="insertapago.php" method="POST" style="max-width:500px;margin:auto">
                                            ...
                                            <select class="form-control mb-3" id="pago" name="pago" placeholder="Método de Pago" onchange="cambiarch()" required>
                                                ...
                                                <option value="pagoe2.php?id=<?php echo $row['cod_reserva'] ?>">EFECTIVO</option>
                                                <option value="pagot2.php?id=<?php echo $row['cod_reserva'] ?>">TARJETA DE CRÉDITO/DÉBITO</option>
                                                <option value="pagosp2.php?id=<?php echo $row['cod_reserva'] ?>">TRANSFERENCIA INTERBANCARIA (SPEI)</option>
