...
<html lang="en">
    <head>
        <title>Check In - Añadir descuento</title>
...
<link rel="stylesheet" href="css/responsive.css?v=2">
        ...
        <script>
        function restar() {
            var total = <?php echo $row['cextras']; ?>; // Valor inicial de 'total'
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Check In - Aplicar descuento</b></h1>
                                <div class="container mt-5">
                                <div class="row"> 
                                    <div>
                                    <div class="card">
                                    <h4 style="text-align: right;">Reserva: #<?php  echo $row['cod_reserva']?> </h4>
                                    <a style="text-align: left;" href="cobrar.php?id=<?php echo $row['cod_reserva'] ?>">
                                    ...
                                    <fieldset>
                                        ...
                                        <br><br>
                                        <h3 class="h3">Introduzca el monto de descuento.</h3>
                                        <br><br>
                                        <form action="insertadesc.php" method="POST" name="eform" onsubmit="return redirect()" style="max-width:500px;margin:auto">
                                            ...
                                            <!--Descuento-->
                                            <input type="int" class="form-control mb-3" name="desc" placeholder="Descuento" required>
                                            <!--Total-->
