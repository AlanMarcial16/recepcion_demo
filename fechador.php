...
include("conexion.php");
    ...
    $sql = "SELECT * FROM reservaciones WHERE fecha BETWEEN '$fecha_inicio' AND '$fecha_fin' ORDER BY fecha ASC";
    $query = mysqli_query($con, $sql);

    $sql2="SELECT *  FROM reservaciones ORDER BY fecha DESC";
                        ...
                        <div>
                                ...
                                <table>
                                        ...
                                        <tr>
                                            ...
                                            <th>$<?php  echo $row['cextras']?>.00</th>
                                            <th>$<?php  echo $row['total']?></th>
                                            <th><?php  echo $row['garantia']?></th>
                                            <th>
                                            <script>
                                                var btnAceptar=document.getElementById("checkin");
                                                var disableButton = function() { this.disabled = true; };
                                                btnAceptar.addEventListener('click', disableButton , false);
                                            </script>
                                                <a href="actualizar.php?id=<?php echo $row['cod_reserva'] ?>">
                                                    <button  type="button" class="btnch" id="checkin" name="checkin">Check In</button>
                                                </a>
                                            </th>
                                            ...
                                            <th>
                                                <a href="insertarpos.php?id=<?php echo $row['cod_reserva'] ?>">
                                                    <button class="btnp">Editar</button>
                                                </a>
                                            </th>
                                            <th>
