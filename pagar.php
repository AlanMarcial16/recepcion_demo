...
<html lang="en">
    <head>
        <script src="js/alerta4.js"></script>
                                    ...
                                    <fieldset>
                                        ...
                                        <form action="insertapago.php" method="POST" style="max-width:500px;margin:auto">
                                            ...
                                            <select class="form-control mb-3" id="pago" name="pago" placeholder="Método de Pago" onchange="cambiarch()" required>
                                                ...
                                                <option value="pagoefectivo.php?id=<?php echo $row['cod_reserva'] ?>">EFECTIVO</option>
                                                <option value="pagotarjeta.php?id=<?php echo $row['cod_reserva'] ?>">TARJETA DE CRÉDITO/DÉBITO</option>
                                                <option value="pagospei.php?id=<?php echo $row['cod_reserva'] ?>">TRANSFERENCIA INTERBANCARIA (SPEI)</option>
                                                <option value="pagoopenpay.php?id=<?php echo $row['cod_reserva'] ?>">OPENPAY</option>
                                            </select>
