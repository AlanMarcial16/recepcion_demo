...
<html lang="en">
    <head>
        ...
        <title>Pago con Openpay - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Pagar - Pago mediante OPENPAY</b></h1>
                                <div class="container mt-5 custom-container">
                                <div class="row"> 
                                    <div>
                                    <div class="card">
                                    ...
                                    <fieldset>
                                        ...
                                        <style>
                                            ...
                                            .centered-image {
                                                display: block;
                                                margin: 0 auto;
                                                max-width: 30%; /* Para asegurarse de que la imagen no supere el ancho del contenedor */
                                            }

                                        </style>
                                        <div class="subtitle-container">
                                            <h3 class="h3">Continue la operación en el portal de Openpay</h3>
                                            <img src="https://images.ctfassets.net/crb83veve8xb/4QkRVZGSCkOU4Y3kNwUj33/4c68056d14adf98a63e07dc8b8c61572/openpay_banner_blog.png" alt="Openpay Banner" class="centered-image">
                                        </div>
                                        ...
                                        <form action="insertapago.php" method="POST" style="max-width:500px;margin:auto">
                                            ...
                                            <input type="hidden" class="form-control mb-3" name="pago" placeholder="Pago" value="Openpay" required>
                                            <hr>
                                            <br>
