...
<html lang="en">
    <head>
        <title>Check Out Cobrar - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Check Out - <?php  echo $row['cliente']?></b></h1>
                                <div class="container mt-5 custom-container">
                                    ...
                                    <div class="container">
                                        ...
                                        <table>
                                            <thead class="table-success table-striped">
                                                <tr>
                                                    <tr>
                                                    <th class="thd" colspan="4">Descripción</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th class="thd" colspan="4">Consumos y Servicios Especiales</th>
                                                        <th class="thd" colspan="2">$<?php  echo $row['textras']?>.00</th>
                                                    </tr>
                                                    <tr>
                                                        <th class="thd" colspan="4">Total habitación</th>
                                                        <th class="thd" colspan="2">$<?php  echo $row['total']?>.00</th>
                                                    </tr>
                                                    
                                                </tbody>
                                        </table> 
                                        <br><br>  
                                        <h2 class="h2">El valor total es de:</h2>
                                        <br><br>
                                        <h1 class="h1" style="<?php echo (($row['textras'] + $row['total']) < 0) ? 'color: red;' : '' ?>">
                                            <b>Total: $<?php echo ($row['textras'] + $row['total']) ?> M.N.</b>
                                        </h1>
                                        <br><br>
                                        <h3 class="h3">Solicite el monto completo al huésped, una vez finalizado presione el botón "Proceder al pago".</h3>
                                        <br><br>
                                        <div style="text-align: right;">
                                        <a href="formcheck.php?id=<?php echo $row['cod_reserva'] ?>">
                                            <button class="btn info"><i class="fa1 fa fa-arrow-left"></i></button>
                                        </a>
                                        <a href="pagarc.php?id=<?php echo $row['cod_reserva'] ?>">
                                        <button class="btn success">Proceder al pago</button>
                                        </a>
                                        </div>
                                    </div>
                                </fieldset>
