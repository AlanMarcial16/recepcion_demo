...
<html lang="en">
    <head>
        <title>Resumen Cotización - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <hr>
                                <h2 class="h2">El valor estimado para la reservación es de:</h2>
                                <br><br>
                                <h1 class="h1">Total: $<?php  echo $row['total']?>.00 M.N.</h1>
                                <br><br>
                                <h3 class="h3">El precio de la habitación está sujeto a disponibilidad de la misma y de los consumos realizados durante su estadía.</h3>
                        </div>
                    </div>
                    </div>  
            </div>
