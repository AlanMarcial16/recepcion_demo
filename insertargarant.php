            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <form action="updatepos7.php" method="POST" style="max-width:500px;margin:auto">
                                    <h1>Seleccione la garantía</h1>
                                    <br>
                                    <hr>
                                    ...
                                    <input type="hidden" class="form-control mb-3" name="comentarios" class="form-control mb-3" placeholder="Comentarios" value="<?php  echo $row['comentarios']?>" readonly>
