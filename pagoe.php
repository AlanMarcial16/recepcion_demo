                                ...
                                <div class="row"> 
                                    ...
                                    <fieldset>
                                        ...
                                        <div style="text-align: center;">
                                            ...
                                            <input type="text" id="campo1" value="<?php echo ($row['textras'] + $row['total']) ?>" readonly/>
                                        ...
                                        <br>
                                        <form action="insertapagoe2.php" method="POST" name="eform" onsubmit="return redirect()" style="max-width:500px;margin:auto">
