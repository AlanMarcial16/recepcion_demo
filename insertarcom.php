            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <form action="updatepos6.php" method="POST" style="max-width:500px;margin:auto">
                                    <h1>Ingrese el comentario</h1>
                                    <br>
                                    <hr>
                                    ...
                                    <input type="int" class="form-control mb-3" name="comentarios" class="form-control mb-3" placeholder="Comentarios" value="<?php  echo $row['comentarios']?>" required>
