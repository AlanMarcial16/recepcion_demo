            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <form action="insertarin2.php" method="POST" style="max-width:500px;margin:auto">
                                    <h1>Ingrese los siguientes campos</h1>
                                    <br>
                                    <hr>
                                    <input type="hidden" name="cod_reserva" value="<?php echo $row['cod_reserva']  ?>">
                                    <p>Fecha</p>
                                    <input type="date" class="form-control mb-3" name="fecha" placeholder="Fecha" value="<?php  echo $row['salida']?>" readonly>
                                    <p>Habitación</p>
                                    <input type="int" class="form-control mb-3" id="habitacion" name="habitacion" placeholder="Habitación" value="<?php  echo $row['habitacion']?>" readonly>
                                    <p>Área</p>
