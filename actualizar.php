            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Check In</b></h1>
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="container">
                                        ...
                                        <br><br>
                                        <h1 style="<?php echo ($row['gtotal'] < 0) ? 'color: red;' : '' ?>">
                                            <b>Total: $<?php  echo $row['gtotal']?>.00 M.N.</b>
                                        </h1>
                                        <div style="text-align: right;">
                                        <a href="cobrar.php?id=<?php echo $row['cod_reserva'] ?>" onclick="return confirmarCobro()">
                                        <button class="btn danger">Continuar</button>
                                        </a>
                                        </div>
                                    </div>
                                </div>
