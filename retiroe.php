...
<html lang="en">
    <head>
        <title>Retiro de efectivo - Casa Flora Handmade Hotel</title>
        ...
        if (result.isConfirmed) {
            ...
            <div class="container mt-5 custom-container">
                <div class="row"> 
                            ...
                            <div id="contenedor">
                                <div id="principal">
                                <form action="insertaop.php" method="POST" style="max-width:700px">
                                        <h1 class="h1">Retiro de efectivo</h1>
                                        <hr>
                                        <p>Tipo</p>
                                        <select class="form-control mb-3" id="tipodeoperacion" name="tipodeoperacion" placeholder="Introduzca el tipo de operación" onchange="" readonly>
                                            <option value="Salida" selected>Salida</option>
                                        </select>
                                        <p>Descripción</p>
                                        <input type="int" class="form-control mb-3" name="descripcion" value="Retiro de efectivo" readonly>
                                        <!--<p>Cantidad</p>
                                        ...
                                        <select class="form-control mb-3" name="tipocomprobante" placeholder="Introduzca el tipo de operación" readonly>
                                    ...
                                    <div class="card">
                                    <div class="container">
                                        <h2><b>Resumen de operaciones</b></h2> 
                                        <br>
                                        <p> Total entradas: $<?php  echo $row['totale']?></p>
                                        <p> Total salidas: $<?php  echo $row['totals']?></p>
                                        <br>
                                        <h4><b> Saldo total en caja: $<?php  echo $row['gtotal']?></b></h4> 
                                    </div>
                                    </div>
