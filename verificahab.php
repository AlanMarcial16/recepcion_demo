...
<html lang="en">
    <head>
        <script src="js/alerta6.js"></script>
        <title>Realizar Checkout - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Checkout</b></h1>
                                <br>
                                <div class="container mt-5 custom-container">
                                <div class="row"> 
                                <div>
                                    <h1 class="h1">VERIFIQUE DETENIDAMENTE LA INTEGRIDAD DE LA HABITACIÓN: <?php  echo $row['habitacion']?> </h1>
                                
                                    <div class="card">
                                    <h4 style="text-align: right;">Reserva: #<?php  echo $row['cod_reserva']?> </h4>
                                    <div class="cont">
                                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSf28jnEEOEbWr8d6HqzWwxazTMvZQiubZOkzlFvhpuvhtpAeg/viewform" target="_blank">
                                        <input class="btn btn-primary btn-lg btn-block" type="button" value="Responder encuesta">
                                    </a>
                                    <br><br>
                                    ...
                                    <br>
                                    <h2>¿La habitación tiene alguna incidencia?</h2>
                                    <br>
                                    <style>.custom-btn-lg {
                                        padding: 20px 30px; /* Ajusta los valores de padding según tus preferencias */
                                        font-size: 24px; /* Ajusta el tamaño de fuente según tus preferencias */
                                    }
                                    </style>
                                    <div class="d-flex justify-content-center">
                                        <a class="btn btn-danger custom-btn-lg m-2" href="registerin2.php?id=<?php echo $row['cod_reserva'] ?>" role="button">Sí</a>
                                        <a class="btn btn-success custom-btn-lg m-2" href="verificagar.php?id=<?php echo $row['cod_reserva'] ?>" role="button">No</a>
                                    </div>
