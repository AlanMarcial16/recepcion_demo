...
<html lang="en">
    <head>
        <title>Información de la reserva - Casa Flora Handmade Hotel</title>
        ...
        if (result.isConfirmed) {
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                                ...
                                <br>
                                <h1 style="text-align: center;"><b>Información de la reserva de: <?php  echo $row['cliente']?></b></h1>
                                    <h2></h2>
                                    <br>
                                    <hr>
                                    <div class="card">
                                    ...
                                    <div class="container">
                                        ...
                                        <h4><b>Llegada</b></h4>  
                                        <input type="text" class="form-control mb-3" name="fecha" placeholder="Fecha" value="<?php  echo $row['fecha']?>" readonly>
                                        <h4><b>Salida</b></h4>  
                                        ...
                                        <h4><b>Tarifa</b></h4>  
                                        <input type="text" class="form-control mb-3" name="tarifa" placeholder="Tarifa" value="<?php  echo $row['tarifa']?>" readonly>
                                        <h4><b>Huéspedes</b></h4>
                                        <input type="text" class="form-control mb-3" name="edades" placeholder="Huéspedes" value="<?php  echo $row['edades']?>" readonly>
                                        </div>
                                        <div class="col-3">
                                        <h4><b>Anticipo</b></h4>
                                        <input type="text" class="form-control mb-3" name="anticipo" placeholder="Anticipo" value="<?php  echo $row['anticipo']?>" readonly>
                                        <h4><b>Reserva Vía</b></h4>
                                        <input type="text" class="form-control mb-3" name="via" placeholder="Vía" value="<?php  echo $row['via']?>" readonly>
                                        <h4><b>Garantia</b></h4>
                                        <input type="text" class="form-control mb-3" name="garantia" placeholder="Ninguno" value="<?php  echo $row['garantia']?>" readonly>
                                        </div>
                                        <div class="col-3">
                                        <h4><b>Noches</b></h4>
                                        <input type="text" class="form-control mb-3" name="noches" placeholder="Noches" value="<?php  echo $row['noches']?>" readonly>
                                        <h4><b>Comentarios</b></h4>
                                        <input type="text" class="form-control mb-3" name="comentarios" placeholder="Comentarios" value="<?php  echo $row['comentarios']?>" readonly>
                                        <h4><b>Servicios Especiales</b></h4>
                                        <?php
                                        $desc_servicios_json = $row['desc_servicios'];

                                        // Utilizar expresión regular para extraer elementos de la cadena
                                        preg_match_all('/"([^"]+)"/', $desc_servicios_json, $matches);

                                        // Verificar si se encontraron coincidencias
                                        if (!empty($matches[1])) {
                                            echo '<textarea class="form-control" rows="5" readonly>';
                                            foreach ($matches[1] as $servicio) {
                                                echo htmlspecialchars($servicio) . "\n";
                                            }
                                            echo '</textarea>';
                                        } else {
                                            echo '<p>No hay servicios especiales</p>';
                                        }
                                        ?>
                                        </div>
                                        </div>
                                        ...
                                        <h1 style="<?php echo ($row['total'] < 0) ? 'color: red;' : '' ?>">
                                            <b>Total Habitación: $<?php  echo $row['total']?> M.N.</b>
                                        </h1>
                                        <br>
                                        <h1 style="<?php echo ($row['textras'] < 0) ? 'color: red;' : '' ?>">
                                            <b>Total Consumos: $<?php  echo $row['textras']?> M.N.</b>
                                        </h1>
                                        <!--<div style="text-align: right;">
                                        <a href="cobrar.php?id=<?php echo $row['cod_reserva'] ?>">
                                        <button disabled class="btn danger">Cobrar</button>
                                        </a>
                                        <a href="verificahab.php?id=<?php echo $row['cod_reserva'] ?>">
                                        <button disabled class="btn success">Comenzar Checkout</button>
                                        </a>
                                        </div>-->
