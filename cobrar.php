...
<html lang="en">
    <head>
        ...
        <title>Check In Cobrar - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Check In -  <?php  echo $row['cliente']?></b></h1>
                                <div class="container mt-5 custom-container">
                                <fieldset> 
                                    <div class="card">
                                        ...
                                        function al() {
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                if (result.isConfirmed) {
                                                    ...
                                                    window.location.href = '/recepcion/adesc1.php?id=<?php echo $row['cod_reserva'] ?>';
                                                }
                                                });
                                    ...
                                    <div class="container">
                                        <div>
                                        <h2 class="h2">El valor total de la reservación es de:</h2>
                                        <br><br>
                                        <h1 class="h1" style="<?php echo ($row['gtotal'] < 0) ? 'color: red;' : '' ?>">
                                            <b>Total: $<?php  echo $row['gtotal']?> M.N.</b>
                                        </h1>
                                        <br><br>
                                        <h3 class="h3">Solicite el monto completo al huésped, una vez finalizado presione el botón "Proceder al pago".</h3>
                                        <br><br>
                                        <div style="text-align: right;">
                                        <a href="asignar_hab.php?id=<?php echo $row['cod_reserva'] ?>">
                                            <button class="btn info"><i class="fa1 fa fa-arrow-left"></i></button>
                                        </a>
                                        <a href="pagar.php?id=<?php echo $row['cod_reserva'] ?>">
                                            <button id="btnPagar" class="btn success">Proceder al pago</button>
                                        </a>
                                        </div>
                                    </div>
                                </fieldset>
