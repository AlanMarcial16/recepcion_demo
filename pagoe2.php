...
<link rel="stylesheet" href="css/responsive.css?v=2">
        ...
        <script>
        function restar() {
            var total = <?php echo $row['textras']; ?>; // Valor inicial de 'total'
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Pagar consumos</b></h1>
                                <div class="container mt-5 custom-container">
                                <div class="row"> 
                                    <div>
                                    <div class="card">
                                    ...
                                    <fieldset>
                                        <div>
                                            <h3 class="h1" style="<?php echo ($row['textras'] < 0) ? 'color: red;' : '' ?>">
                                                <b>Total a Pagar: $<?php echo $row['textras']  ?> M.N.</b>
                                            </h3>
                                            <br><br>
                                        ...
                                        <div style="text-align: center;">
                                            ...
                                            <input type="text" id="campo1" value="<?php echo $row['textras']; ?>" readonly/>
                                        ...
                                        <br>
                                        <form action="insertapagoe3.php" method="POST" name="eform" onsubmit="return redirect()" style="max-width:500px;margin:auto">
