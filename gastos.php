...
<html lang="en">
    <head>
        <title>Gastos - Casa Flora Handmade Hotel</title>
            ...
            <div class="header">
                <a href="inicio.php" class="logo">
                    ...
                    <div class="header-right">
                        ...
                        <a class="active" href="gastos.php">Gastos</a>
            ...
            <div class="container mt-5 custom-container">
                <div class="row"> 
                        <div>
                            ...
                            <h1 style="text-align: center;"><b>Gastos</b></h1>
                            <br>
                            <!-- Gastos -->
                            <table>
