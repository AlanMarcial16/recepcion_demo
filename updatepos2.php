...
$sextras_actual = $row_select['sextras'];
$cextras = $row_select['cextras'];
...
$sextras_nuevo = $sextras_actual + $_POST['sextras'];

$textras = (-$sextras_nuevo - $cextras);
...
$sql_update = "UPDATE reservaciones SET sextras='$sextras_nuevo', desc_servicios='$desc_servicios_nuevo' WHERE cod_reserva='$cod_reserva'";
...
if ($query_update) {
    ...
    $datos_ticket = array(
        ...
        "cantidad" => 1,
        "preciou" => $_POST['sextras'],
        "mensaje" => "Servicios especiales"
    );
