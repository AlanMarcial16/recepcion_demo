...
<html lang="en">
    <head>
        <title>Finalizar Checkout - Casa Flora Handmade Hotel</title>
                    ...
                    <div class="row"> 
                        <div>
                                ...
                                <div>
                                    ...
                                    <!--COMENTARIOS (ESTE APARTADO SE SUBIRÁ EN CASO DE QUE LA RESERVA CUENTE CON COMENTARIOS DE MAYOR EXTENSIÓN)-->
                                    <input type="hidden" class="form-control mb-3" name="comentarios" placeholder="Comentarios" value="<?php  echo $row['comentarios']?>" readonly>
                                    <!--PAGO-->
                                    <input type="hidden" class="form-control mb-3" name="pago" placeholder="Pago" value="<?php  echo $row['pago']?>" readonly>
                                    </div>
                                    <div class="col-4">
                                    <h4><b>Garantía</b></h4>
                                    <input type="int" class="form-control mb-3" name="garantia" placeholder="Garantía" value="<?php  echo $row['garantia']?> (DEVUELTO)" readonly>
                                    </div>
                                    <div class="col-4">
                                    <h4><b>Total</b></h4>
                                    ...
                                    <br>
                                    <br>
                                    <input type="submit" class="btn btn-success btn-block" value="Finalizar Checkout">
                                    <h1></h1>
                                    <a class="btn btn-danger" href="checkout.php" role="button">Cancelar</a>
                                    </form>
                                    </div>
                                </div>
                                <br>
