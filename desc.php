...
<html lang="en">
    <head>
        <title>Añadir descuento (Check Out) - Casa Flora Handmade Hotel</title>
                    ...
                    <div class="row"> 
                        <div>
                                ...
                                <div class="row"> 
                                    ...
                                    <fieldset>
                                        <div>
                                        <h2 class="h2">Añadir descuento</h2>
                                        <br><br>
                                        <h3 class="h1">Total a Pagar: $<?php echo $row['total']  ?> M.N.</h3>
                                        <br><br>
                                        <h3 class="h3">Introduzca el porcentaje de descuento</h3>
                                        <br><br>
                                        <div style="max-width:500px;margin:auto">
                                        <span>Total</span>
                                        <input type="text" id="campo1" value="<?php echo $row['total']  ?>" readonly/>
                                        <script>$("#campo1").one( "click", function() { sumar(this.value); } );</script>
                                        <br/ >
                                        <span>Descuento %</span>
                                        <input type="text" id="campo2" onchange="sumar(this.value);" />
                                        <br/ >
                                        <span class="h4">Devuelva: $</span><span class="h4" id="spTotal"></span><span class="h4">.00 de cambio</span>
                                        </div>
                                        <br>
                                        <form action="insertapago.php" method="POST" name="eform" onsubmit="return redirect()" style="max-width:500px;margin:auto">
                                            ...
                                            <!--Total-->
                                            <input type="hidden" class="form-control mb-3" name="total" placeholder="Total" value="0" required>
