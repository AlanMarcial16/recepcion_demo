            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <h1 style="text-align: center;"><b>Pagar - Pago con transferencia</b></h1>
                                <div class="container mt-5 custom-container">
                                <div class="row"> 
                                    <div>
                                    <div class="card">
                                    ...
                                    <fieldset>
                                        ...
                                        <BR>
                                        <h3 class="h3">Muestre los siguientes datos al cliente y pida validar la operación con comprobante</h3>
                                        <br>
                                        <fieldset>
                                        <div class='textarea' style="max-width: 500px; margin: auto; text-align: center;">
                                        <br> 
                                        ...
                                        <br>
                                            ...
                                            <form action="insertapago2.php" method="POST" style="max-width:500px;margin:auto">
