...
<html lang="en">
    <head>
        <script src="js/alerta7.js"></script>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <div class="row"> 
                                <div>
                                    <h1 class="h1">Devuelva la garantía a la habitación: <?php  echo $row['habitacion']?> </h1>
                                    <div class="cont">
                                    ...
                                    <div id="div2" class="col-8">
                                    <h1 style="text-align: center;"><b><?php  echo $row['garantia']?></b></h1>
                                    </div>
                                    <hr>
                                    <br>
                                    <style>.custom-btn-lg {
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a class="btn btn-danger custom-btn-lg m-2" href="verificahab.php?id=<?php echo $row['cod_reserva'] ?>" role="button"><i class="fa1 fa fa-arrow-left"></i></a>
                                        <a class="btn btn-success custom-btn-lg m-2" href="endco.php?id=<?php echo $row['cod_reserva'] ?>" role="button" role="button">Listo</a>
                                    </div>
