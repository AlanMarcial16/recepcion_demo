...
<html lang="en">
    <head>
        <title>Agregar Servicios Especiales - Casa Flora Handmade Hotel</title>
            ...
            <div class="container mt-5 custom-container">
                    <div class="row"> 
                        <div>
                                ...
                                <form action="updatepos2.php" method="POST" style="max-width:500px;margin:auto">
                                    ...
                                    <p>Elija los servicios</p>
                                    <select class="form-control mb-3" id="opciones" onchange="agregarTabla()">
                                        <option selected>Seleccione una opción</option>
                                        <option value="600">Adulto extra (12 años en adelante)</option>
                                        <option value="350">Menor extra (3-11 años) </option>
                                        <option value="250">Descorche por botella o six</option>
                                        <option value="500">Decoración romántica</option>
                                        <option value="900">Atardecer romántico</option>
                                        <option value="1600">Velada romántica</option>
                                        <option value="500">Early check in</option>
                                        <option value="250">Late check out</option>
                                        <option value="2500">Eventos especiales</option>
                                        <option value="600">Masajes</option>
                                    </select>
                                    ...
                                    <input type="int" class="form-control mb-3" name="sextras" placeholder="Introduzca el total de Servicios Especiales" pattern="^[^-]*$" oninput="this.value = this.value.replace(/[^\d.-]/g, '')" required>
