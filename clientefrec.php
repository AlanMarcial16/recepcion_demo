                    ...
                    <div class="row"> 
                        <div>
                                ...
                                <a href="tabla_clientes.php">
                                    <button class="btn success"><i class="fa1 fa fa-table"></i></button>
                                </a>
                                </div>
                                <br>
                                <h1 class="h1">Cliente frecuente - Registro</h1>
                                <br>
                                <hr>

                                <form action="insertarclient.php" method="POST">
                                    <div class="form-container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="int" id="apellidos" name="apellidos" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="procedencia">Estado de procedencia:</label>
